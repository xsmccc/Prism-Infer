...
1. P5.2: 实现首个 logical visual token pruning/retention 策略，并输出 token 保留率和质量退化。
2. P5.3: 在 pruning correctness 稳定后评估物理 KV compaction 或 FP8 KV baseline。
3. P5.4: 输出压缩率、质量退化、显存/延迟数据和 `docs/COMPRESSION_REPORT.md`。
