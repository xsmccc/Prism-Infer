...
- [ ] P6.12 Content-aware visual pruning:
  ...
  - [ ] P6.12-B 首个质量合格策略：当前 attention/uniform task gate 均 FAIL。下一轮调查视觉网格 coverage、跨 query/layer 聚合和动态预算；任何策略通过 fidelity 与 reference task preflight 前，不进入稳定性能矩阵。
