...
- `docs/PERFORMANCE_REPORT.md`: P6/P7 benchmark contract、trace-driven优化、外部对比和结论边界。
- `docs/CLAIMS.md`: 当前允许、必须限定和禁止使用的项目结论。
- `docs/issues/`: 性能问题从发现、root cause、修复到回归的独立档案。
